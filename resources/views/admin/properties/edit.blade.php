                            ...
                            <label class="label">
                                ...
                                <select name="category" class="select2">
                                    ...
                                    <option value="commercial_industrial"
                                        {{ (old('category') == 'commercial_industrial' ? 'selected' : ($property->category == 'commercial_industrial' ? 'selected' : ''))}}>
                                        Comercial/Industrial</option>
                                    <option value="terrain"
                                        {{ (old('category') == 'terrain' ? 'selected' : ($property->category == 'terrain' ? 'selected' : ''))}}>
                                        Terreno</option>
                                </select>
                            </label>
                                ...
                                <select name="type" class="select2">
                                    <optgroup label="Imóvel Residencial">
                                        <option value="home"
                                            ...
                                            Casa</option>
                                        <option value="roof"
                                            {{ (old('type') == 'roof' ? 'selected' : ($property->type == 'roof' ? 'selected' : ''))}}>
                                            Cobertura</option>
                                        <option value="apartment"
                                            {{ (old('type') == 'apartment' ? 'selected' : ($property->type == 'apartment' ? 'selected' : ''))}}>
                                            Apartamento</option>
                                        <option value="studio"
                                    ...
                                    <optgroup label="Comercial/Industrial">
                                        <option value="commercial_room"
                                            {{ (old('type') == 'commercial_room' ? 'selected' : ($property->type == 'commercial_room' ? 'selected' : ''))}}>
                                            Sala Comercial</option>
                                        <option value="deposit_shed"
                                            {{ (old('type') == 'deposit_shed' ? 'selected' : ($property->type == 'deposit_shed' ? 'selected' : ''))}}>
                                            Depósito/Galpão</option>
                                        <option value="commercial_point"
                                            {{ (old('type') == 'commercial_point' ? 'selected' : ($property->type == 'commercial_point' ? 'selected' : ''))}}>
                                            Ponto Comercial</option>
                                    </optgroup>
                                    <optgroup label="Terreno">
                                        <option value="terrain"
                                            {{ (old('type') == 'terrain' ? 'selected' : ($property->type == 'terrain' ? 'selected' : ''))}}>
                                            Terreno</option>
                                    </optgroup>
                                </select>
                            </label>
