                            ...
                            <div class="app_collapse_content">
                                <div class="label_g2">
                                    <label class="label">
                                        ...
                                        <select name="owner" data-action="{{ route('admin.contracts.getDataOwner') }}">
                                            <option value="">Informe um Cliente</option>
                                            @foreach($lessors->get() as $lessor)
                                            <option value="{{ $lessor->id }}"
                                                {{ (old('owner') == $lessor->id ? 'selected' : '') }}>
                                                {{ $lessor->name }}
                                                ({{ $lessor->document }})
                                            </option>
                                            @endforeach
                                    ...
                                    <label class="label">
                                        ...
                                        <select name="acquirer"
                                            ...
                                            <option value="{{ $lessee->id }}"
                                                {{ (old('acquirer') == $lessee->id ? 'selected' : '') }}>
                                                {{ $lessee->name }}
                                                ({{ $lessee->document }})
                                            </option>
                                            @endforeach
